var projects_json = {
    "thesis": {
        ...
        "content": "My culminating Master's project earned a commencement award for Best Master's Thesis within my department at NYU (Integrated Design and Media). Its prototypes, published on Snapchat's platform, have earned an astounding 4 million interactions in their first three months! One of them even sat trending #1 for an extended weekend. My thesis examines what it means to augment emotion with facial expressions, effectively recreating emojis in AR. The full disertation is published <a href='https://www.proquest.com/docview/2681087514'>here</a> and <a href='https://drive.google.com/file/d/1KVSEdmXdkCZNjPrJMEDLxz3oHTqzDiI8/view'>here</a>.</p><p></p><strong>Defense Presentation</strong><p></p><div class='embed-responsive embed-responsive-16by9'><iframe class='embed-responsive-item' src='https://www.youtube.com/embed/GC5AZ56BBn4?rel=0' allowfullscreen></iframe></div><p style='padding: 10px;'></p><strong>Mid-thesis Update</strong><p></p><div class='embed-responsive embed-responsive-16by9'><iframe class='embed-responsive-item' src='https://www.youtube.com/embed/Cz3_kvUQ3mk?rel=0' allowfullscreen></iframe></div><p></p>While there’s no doubt that companies are facilitating, if not encouraging, immersive experience creation, arguably little has been done to formalize a path for expressing emotions in augmented reality. Consider the emotions of an in-person, face-to-face conversation with another peer. Each interlocutor expresses nonverbal cues through channels such as facial expressions, gestures, movement, and posture. This frames the content and emotions of the conversation, clarifying the intent of the information.<p></p>In digital, computer-mediated communication such as instant-messaging, users initially resorted to expressing nonverbal cues through emoticons. Eventually, emojis were introduced as a means to more succinctly convey complex nonverbal information, and finally the adoption of GIFs provided an opportunity for conveying embodied actions. Evidently, over the last several decades, digital mediums aimed to emulate the nonverbal cues of in-person communication, viewing it as the standard to reach.<p></p>Augmented reality can go beyond the standard of in-person communication, particularly in the expression of nonverbal cues, and introduce new elements to enrich conversations. Potentially for the first-time in the history of humanity, society can add nonverbal cues that go beyond the level of information conveyed in-person. So, companies must emphasize correctly augmenting emotion. In order to help companies correctly dedicate limited resources to furthering the potential expressive aspects of augmented reality, <b>I am studying the facial expressions of entertaining, narrative communication through mobile augmented reality to understand how virtual elements can provide additional expressive opportunities in peer-to-peer contact.</b><p></p>Currently, I have published prototypes for seven augmented reality filters on Snapchat's platform. These filters use facial expression to drive and reveal augmented elements. Some of these filters are based off of a single emotion, such as sadness and anger, while others are collections of multiple emotions selectable via a carousel user interface. Over the first month of these prototypes, they have amassed 700,000 interactions with the most popular commanding 500,000 of those interactions! Undoubtedly, the popularity of these prototypes emphasizes the importance of conveying emotion through digital mediums including augmented reality. I have further verified this through independent evaluation of my filters. Eighteen volunteers used my prototypes for at least a week, then answered a survey about their usage and feelings. They noted joy, entertainment, and better connection when using these filters."
    },
    "duck": {
        "title": "WIP - Duck Fun",
        "category": "ar",
        "link-text": "Learn More",
        "content": "<p style='text-align: center'><iframe src='https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:6945772000330092545?compact=1' height='284' width='504' frameborder='0' allowfullscreen='' title='Embedded post'></iframe></p><div class='embed-responsive embed-responsive-16by9'><video controls class='embed-responsive-item'><source src='./images/Videos/DuckFun.MP4' type='video/mp4'></video></div><p></p><p>In appropriate instances, I believe forcing users to confront virtual elements with their physical self improves connectedness. There's no doubt AR presents an opportunity to introduce these unique interactions that go beyond usual 2D screens and graphics. At least in my bubble, I often see AR headset users reaching out and controlling virtual elements. I'd love to see more of that in mobile AR!</p><p>What started as a silly project about grabbing ducks is expanding into something interesting and meaningful that aims to bring more unique and complex AR interactions to mobile. I initially began by implementing grabbing and releasing mechanics, with my test virtual subjects being a duck. I wanted users to interact with virtual elements much like they would any other real object (cup, remote, notebook, etc). To make the virtual elements feel more part of the physical world, I expanded the project to include physics. The ducks could now be thrown, collide with one another, and react to forces of gravity. Now, I'm implmenting the user's hands as a 3D paintbrush, allowing them to create their own ideas from seemingly nothing.<p></po>In the future, I will bring these features together to tell a more compelling story through a game or artpiece. While the interactions and mechanics of this project add a physical familiarity, I want to add unique visuals that are not so common, better engage the user, and maintain their attention. Ultimately, I recognize that AR presents an opportunity to go beyond what is physically capable. Furthermore, I am considering expanding this project into an open-source library so that others can quickly integrate 3D equivalents of common 2D inputs into their own projects.</p>"
    },
    "ar_map": {
        "title": "Real-time Map",
        "category": "ar",
    ...
    "aliens": {
        "title": "Motivating Workouts in Augmented Reality",
        "category": "ar",
        "link-text": "Learn More",
        "content": "<div class='embed-responsive embed-responsive-16by9'><iframe class='embed-responsive-item' src='https://www.youtube.com/embed/IWnvQiyeFk4?rel=0' allowfullscreen></iframe></div><p></p>Location-specific augmented reality is interesting because it grounds virtual artifacts to a real-world setting. The artifacts have enhanced meaning and relevance because of their surroundings, and viewers feel as if artifacts are really there. When tasked with pitching a GPS-based AR experience in my mobile-augmented reality class, we were also asked to create a story around it. To create the experience, we used Metaverse AR and any assets of our choosing. Metaverse AR, although discontinued, allows users to create AR experiences in the style of role-playing and ground them in real life. Users can add sound-effects, multiple states, and other interactions to create a narrative experience. While very simple and easy to use, this allowed me to focus on what kind of experience I would be creating.<p></p>As a track and field athlete and enthusiast, at the time of this piece I was actively training at East River Park in New York City. Thus, a perfect location an experience to tie to an AR story. Next, I thought of the track events that would make sense to chain together. I could not do jumping eevnts because of the lack of equipment. Running involves getting from multiple points, and throwing is stationary. The latter two signaled a narrative about getting from various points, collecting throwing equipment, and launching it at an enemy. I chose an alien as that enemy. I also envisioned that a future AR application could create workout challenges around silly games (i.e. fighting an alien) based in specific locations.<p></p>Because the AR would be a rough proof-of-concept, I spent quite some time on script, filming, and editing to really sell the experience. I wrote out a detailed script and recorded it with my roommate Sagar. I envisioned myself really believing in this AR experience by embodying the role of an \"alien hunter,\" yet I wanted to ground it in reality by using Sagar, my cameraman, as a sensible unseen character. The final result proved quite entertaining for my classmates and myself."
    },
    "bike": {
