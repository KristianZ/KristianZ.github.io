var projects_json = {
    ...
    "emessage": {
        ...
        "category": "design",
        "link-text": "Learn More",
        "content": "Throughout NYU's Theories of Design, Media, and Technology course, students discussed the history of contemporary artifacts from around the world through the lens of users, designers, and philosophers. However, I particularly took interest in the forms and influences of orality throughout western history as described by Walter Ong and Marshall McLuhan. In a 3500 word paper I wrote for the class, I covered eras of orality such as primary orality, residual-manuscript orality, print culture orality, secondary orality, and a theorized digital orality. Without writing, speech united a physicial space by aggregating knowledge about the immediately surrounding world. Through the adoption of writing, gestures and tone became more important for reciting and abstract thought became more possible. Later, through the adoption of media technology, users and studios used effects to heighten emotions at certain moments. My culminating project focused on how modern, digital orality provides new affordances for better emotional expression. I wanted to redesign a digital communication platform around emotion by embracing the technological affordances available in digital orality and pulling from the strenghts of past western developments of orality.<p></p>In my proposed platform, when a user types a message artificial intelligence algorithms built into the platform classify the message as an emotion. The algorithms also assign a character (two or three dimensional, fictional or nonfictional, animated person) and generate a corresponding animation performing the message. Readers can see this animation by tapping on the messages. Importantly, algorithm suggestions are discerned from group habits and only occasionally are societal habits introduced for novelty. Users maintain control over their message selections, and any deviation from suggestions go forward to train the algorithm.<p></p>The decoration of messages also pulls form research suggesting that a sole emoticon better contextualizes emotion and that response time best signals tone. Consequently, messages are seen as emoticons and spaced according to when they were sent. Color, shape, notifcation sound, and notifcation vibration are also configurable to present additional decorations of emotion in a message.<p></p><p style='text-align: center;'>Below is a GIF built in Adobe XD blueprinting the application.</p><p style='text-align: center;'><img style='width: 50%;' src='./images/Videos/eMessage.gif' alt='GIF illustrating eMessage features'/></p>"
    },
    "apartment": {
        "title": "Recreating an Apartment Virtually",
        "category": "design",
        "link-text": "Learn More",
        "content": "When my girlfriend moved into her new apartment, she had trouble deciding what furniture to buy. Prior to any purchasing, she wanted to see the furniture placed within her apartment and create arrangments she confidently liked. To help her with that process, I recreated my girlfriend's apartment virtually. The virtual model is not perfectly to scale, however it is very close. Creating furniture, updating placements, and rendering took around 5 minutes for every pass.<p></p><div class='embed-responsive embed-responsive-16by9'><iframe class='embed-responsive-item' src='https://www.youtube.com/embed/FREqB_XW8bo?rel=0' allowfullscreen></iframe></div>"
    },
    "rooftop": {
